...
const JourneyConnections = ({ journeyForm, setJourneyForm }) => {
    return (
        <div>
            <br />
           <h4><strong>Connect with investors and Enterpreneurs</strong></h4>
            ...
            <JourneySaveButton pageValue="06"  nextPageName='JourneyCommunity' journeyForm={journeyForm} setJourneyForm={setJourneyForm}  />
